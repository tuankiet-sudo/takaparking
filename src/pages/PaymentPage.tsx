    ...
    return (
        <Box sx={{ bgcolor: '#f7f7f7' }}>
            ...
            <Box sx={{ p: 2 }}>
                ...
                <InstructionStep
                    number="01"
                    title="Nhập thông tin biển số xe/ mã thẻ"
                    subtitle="Search your vehicle license plate or parking card number in the search box"
                    icon={<SearchIcon fontSize="inherit" />}
                />
                <InstructionStep
                    number="02"
                    title="Chụp mã Barcode hoá đơn và mã Voucher"
                    subtitle="Take a photo of Barcode bill and Voucher (if any)"
                    icon={<i className="fa-solid fa-barcode" style={{fontSize: '32px'}}></i>}
                />
                <InstructionStep
                    number="03"
                    title="Chọn phương thức thanh toán"
                    subtitle="Choose payment method that suits you"
